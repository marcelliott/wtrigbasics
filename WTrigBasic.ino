...
int i;
  ...
  if (gSeqMetro.check() == 1) {
      Serial.print("gSeqMetro.check()==1");
      Serial.println();
      ...
      switch (gSeqState) {
          ...
          case 0:
              Serial.print("Demonstrate how to fade in a music track");
              Serial.println();
              wTrig.samplerateOffset(0);            // Reset our sample rate offset
              wTrig.masterGain(0);                  // Reset the master gain to 0dB
              
              wTrig.trackGain(MUSIC_TRACK, -40);              // Preset Track 2 gain to -40dB
              wTrig.trackPlayPoly(MUSIC_TRACK);               // Start Track 2
              wTrig.trackFade(MUSIC_TRACK, 0, 2000, 0);       // Fade Track 2 up to 0dB over 2 secs
          break;

          // State 1: Demonstrates how to cross-fade music tracks
          case 1:
              Serial.print("Demonstrate how to cross-fade music track");
              Serial.println();
          ...
          case 2:
              Serial.print("Fade down music and start looping dialog");
              Serial.println();
          ...
          case 3:
              Serial.print("Honk horn 2 times");
              Serial.println();
              //wTrig.stopAllTracks();
              wTrig.trackPlayPoly(HORN_TRACK);               // Start Track poly
              delay(500);
              wTrig.trackStop(HORN_TRACK);                   // Stop Track
              delay(250);
              wTrig.trackPlayPoly(HORN_TRACK);               // Start Track poly
              delay(500);
              wTrig.trackStop(HORN_TRACK);                   // Stop Trac
          break;
          ...
          case 4:
              Serial.print("Demonstrate how to fade in a music track");
              Serial.println();
              wTrig.trackLoop(MUSIC_TRACK, 0);                // Disable Track 4 looping
              wTrig.trackFade(MUSIC_TRACK, -50, 5000, 1);     // Fade Track 4 to -50dB and stop
          break;
          
          // State 5: This demonstrates playing musical instrument samples, with decay on
          //  release
          case 5:
              Serial.print("Demo decay on dealy - 3 poly tracks");
              Serial.println();
          ...
          case 6:
              Serial.print("Demo sample-sync - 3 tracks, pitch bending");
              Serial.println();
